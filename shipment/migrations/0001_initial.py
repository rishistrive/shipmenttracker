# Generated by Django 3.2.7 on 2022-05-17 01:00
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('Sending', 'sending'), ('Pending', 'Pending'), ('Received', 'Received')], default='Pending', max_length=20)),
                ...
                ('supplier', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='supplier', to=settings.AUTH_USER_MODEL)),
            ],
        ),
    ]
